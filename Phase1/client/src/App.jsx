...
function App() {
  ...
  useEffect(() => {
    fetch("https://genai-backend-o27z.onrender.com/api/messages")
      .then(res => res.json())
      .then(data => {
        setMessages(data);
      })
  ...
  // Add user and empty assistant together
  setMessages(prev => [
    ...prev,
    userMessage,
  ...
  // Send it to backend
  const response = await fetch("https://genai-backend-o27z.onrender.com/api/chat", {
    method: "POST",
